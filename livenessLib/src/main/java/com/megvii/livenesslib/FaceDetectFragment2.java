...
import com.megvii.livenesslib.bean.FaceSearchBean;
import com.megvii.livenesslib.bean.FaceppBean;
import com.megvii.livenesslib.bean.FacesetTokenBean;
import com.megvii.livenesslib.bean.PreviewFrameBean;
...
public class FaceDetectFragment2 extends BaseFragment {
    ...
    private static final String API_KEY = "62xXRy3S6tVNNUoFLXQlze-hQXTa-RPN";
    private static final String API_SECRET = "SSm555ZZm2CyZfb8g63yOanlCH1h5INl";
    ...
    protected void setParmBackFinish(byte[] bytes, int width, int height) {
        ...
        Bitmap bmp = ImgUtil.byte2Bitmap(bytes, width, height);
        if (bmp == null) return;
        final String s = ImgUtil.base64(bmp);
