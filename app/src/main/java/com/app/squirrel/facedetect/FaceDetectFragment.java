...
import com.app.squirrel.facedetect.util.AutoFocusHelper;
import com.app.squirrel.facedetect.view.AutoFitTextureView;
...
/**
 */
public class FaceDetectFragment extends BaseFragment implements ActivityCompat.OnRequestPermissionsResultCallback {
     ...
     */
    private static final String TAG = "face_detect_fragment";
    ...
    private static FaceDetectFragment INSTANCE;
     ...
     */
    private String mCameraId = CAMERA_FRONT; // Default back camera
    /**
    ...
    private boolean setUpCameraOutputs() {
        ...
        try {
            ...
            for (String cameraId : manager.getCameraIdList()) {
                ...
                Log.e(TAG, "CameraCharacteristics:" + characteristics);
                if ((!cameraId.equals(CAMERA_FRONT) && (!cameraId.equals(CAMERA_BACK))
                        || (!cameraId.equals(mCameraId)))) {
                    continue;
                }

                Log.e(TAG, "CameraCharacteristics 1:" + Arrays.toString(characteristics.getKeys().toArray()));
                ...
                Log.e(TAG, "CameraCharacteristics 2:" + characteristics);
                ...
                synchronized (mCameraStateLock) {
                    ...
                    Log.e(TAG, "CameraCharacteristics: mCharacteristics:" + mCharacteristics);
                }
                return true;
            }
        } catch (CameraAccessException e) {
            e.printStackTrace();
            Log.e(TAG, "CameraAccessException: e:" + e.getMessage());
        }
     ...
     */
    public static class PermissionConfirmationDialog extends android.support.v4.app.DialogFragment {
